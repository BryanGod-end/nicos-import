...
export default function Entrega() {
  ...
  const [metodo, setMetodo] = useState('envio'); // 'envio' | 'recojo'
  ...
  // Provincias disponibles según el departamento elegido
  ...
  function handleSubmit(e) {
    e.preventDefault();
    navigate('/checkout/pago'); // el paso "Pago" lo construimos después
  }
